...
// APIClient manages communication with the Equinix Fabric API v4 API v4.3.52
...
type APIClient struct {
	...
	NexusNetworksApi *NexusNetworksApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.NexusNetworksApi = (*NexusNetworksApiService)(&c.common)
