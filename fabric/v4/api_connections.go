...
func (a *ConnectionsApiService) CreateConnectionAction(ctx context.Context, body ConnectionActionRequest, connectionId string, localVarOptionals *ConnectionsApiCreateConnectionActionOpts) (Connection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *ConnectionsApiService) ValidateConnections(ctx context.Context, body ValidateByAuthKeyPostRequest, localVarOptionals *ConnectionsApiValidateConnectionsOpts) (ConnectionResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
